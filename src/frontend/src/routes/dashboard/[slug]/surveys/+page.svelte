<script lang="ts">
	...
	import SurveyResult from "../../../../components/dashboard/project/surveyMain/SurveyResult.svelte";

	$: surveys = $page.data.project.surveys;
</script>

<ProjectViewLayout gridClass="grid-cols-3 md:grid-cols-4 lg:grid-cols-6">
	<HeaderTile projectName={$page.data.project.name} categoryName="Surveys" health={surveys.health}>
