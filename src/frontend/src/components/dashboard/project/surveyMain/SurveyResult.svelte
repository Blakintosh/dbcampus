    ...
    <table class="w-full border-collapse h-full rounded-md overflow-hidden my-4">
        <thead>
            <tr class="text-slate-50 text-left">
                <th class="p-1 px-2 bg-slate-500 font-semibold"></th>
                <th class="p-1 px-2 bg-slate-500 font-semibold">Question</th>
                <th class="p-1 px-2 bg-slate-500 font-semibold">Feedback</th>
            </tr>
        </thead>
        <tbody>
